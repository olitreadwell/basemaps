...
Using [@basemaps/server](../server/README.md) an entire local test environment can be run. to ensure the latest assets are served by the local server `npm run bundle` should be run first
